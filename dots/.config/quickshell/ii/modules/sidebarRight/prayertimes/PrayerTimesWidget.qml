...
Item {
    ...
    readonly property var prayerNames: {
        "fajr": "Fajr",
        "dhuhr": "Dhuhr",
        "asr": "Asr",
        "maghrib": "Maghrib",
        ...
        ColumnLayout {
            ...
            ListView {
                ...
                delegate: Rectangle {
                    ...
                    color: PrayerTimes.prayerData.nextPrayerName === root.prayerNames[modelData] ? Appearance.colors.colPrimaryContainer : "transparent"
                    RowLayout {
                        anchors.fill: parent
                        anchors.margins: 10
                        spacing: 15
                        StyledText {
                            Layout.fillWidth: true
                            color: PrayerTimes.prayerData.nextPrayerName === root.prayerNames[modelData] ? Appearance.m3colors.m3onPrimaryContainer : Appearance.m3colors.m3onSurface
                            font.bold: PrayerTimes.prayerData.nextPrayerName === root.prayerNames[modelData]
                            text: root.prayerNames[modelData]
                        }
                        StyledText {
                            color: PrayerTimes.prayerData.nextPrayerName === root.prayerNames[modelData] ? Appearance.m3colors.m3onPrimaryContainer : Appearance.m3colors.m3onSurfaceVariant
