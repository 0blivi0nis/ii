...
Scope {
    ...
    component CornerPanelWindow: PanelWindow {
        ...
        visible: (Config.options.appearance.fakeScreenRounding === 1 || (Config.options.appearance.fakeScreenRounding === 2 && !fullscreen) || (Config.options.appearance.fakeScreenRounding === 3 && !fullscreen))
        property var corner
